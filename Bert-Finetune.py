...
pretrained_llama2_path = './scibert_scivocab_uncased'
#A800和A100路径是一样的
A100_labels_path = "/root/autodl-tmp/data/fenlei-12w/label_matrix.txt"
A100_cases_path = "/root/autodl-tmp/data/fenlei-12w/patent_claims_text.txt"
out_model_path = "/root/autodl-tmp/Patent_Claims_Retrieval/output/scibert-finetune/scibert-finetune.pth"#存储路径

tokenizer = AutoTokenizer.from_pretrained(pretrained_llama2_path,use_fast = True)

embedder= BertModel.from_pretrained(pretrained_llama2_path, output_hidden_states=True, return_dict=True)
...
class Bert_finetune(torch.nn.Module):
    def __init__(self):
        ...
        self.liner = torch.nn.Linear(768, 656)
    def forward(self, input_ids,attention_mask):
        ...
        cls_feature = features[:,0,:]#取第一个token
